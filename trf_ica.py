...
decomposition = make_pipeline(FastICA(10), MinMaxScaler())
model = DecomposingTopicModel(representation, decomposition)
...
joblib.dump(pipe, out_dir.joinpath("trf_ica.joblib"))

print("Producing figures.")
figures_dir = Path("figures/trf_ica")
