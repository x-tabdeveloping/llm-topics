...
topic_map.write_html(figures_dir.joinpath("topic_barcharts.html"))
topic_wordclouds = figs.topic_wordclouds(corpus, pipeline=pipe)
topic_map.write_html(figures_dir.joinpath("topic_wordclouds.html"))
word_map = figs.word_map(corpus, pipeline=pipe)
topic_map.write_html(figures_dir.joinpath("word_map.html"))
